...
router.post('/', async (req, res) => {
  try {
    ...
    const activity = await Activity.create({
      ...
      linkedMilestone: req.body.linkedMilestone || null,
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const updated = await activity.update({
      ...
      linkedMilestone: req.body.linkedMilestone !== undefined ? req.body.linkedMilestone : activity.linkedMilestone,
      ...
      actualStartDate: req.body.actualStartDate !== undefined ? req.body.actualStartDate : activity.actualStartDate,
      actualEndDate: req.body.actualEndDate !== undefined ? req.body.actualEndDate : activity.actualEndDate,
